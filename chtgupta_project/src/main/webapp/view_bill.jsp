...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Bill Payment Details</font>
	</div>
	...
	<div class="card ">
	  ...
	  <div class="card-body">
	    	...
	    	<input class="form-control" type="text" name="mno" value="<%out.println(rs1.getString(4));%>" readonly>
	    	
	    	<label class="mt-3">Consumer Name</label>
	    	<input class="form-control" type="text" value="<%out.println(rs1.getString(6));%>" readonly>
	    	
	    	<label class="mt-3">Connection Type</label>
	    	<input class="form-control" type="text" value="<%out.println(rs1.getString(7));%>" readonly>
	    	
	    	<label class="mt-3">Units Used</label>
	    	<input class="form-control" type="text" value="<%out.println(rs1.getString(8));%>" readonly>
	    	
	    	<label class="mt-3">Amount</label>
	    	<input class="form-control" type="text" value="<%out.println(rs1.getString(9));%>" readonly>
	    	
	    	<label class="mt-3">Status</label>
	    	<input class="form-control mb-4" type="text" name="due" value="<%out.println(rs1.getString(11));%>" readonly>
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
			...
			<label class="mt-3">Enter Your 16 Digits Card Number</label>
	    	<input class="form-control" name="cno" type="text"  required>
	    	
	    	<div class="d-flex justify-content-end">
	    		<input type="submit" class="btn btn-primary my-3" value="Pay Bill">
	    	</div>
	  </div>
	</div>
	</form>
	...
	<div class="card text-light bg-success mt-5">
		<div class="card-header">
