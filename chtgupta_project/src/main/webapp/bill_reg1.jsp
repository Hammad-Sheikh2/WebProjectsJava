...
{
	request.setAttribute("msg", "Sorry, Process Failed. The meter number you selected already have a bill against it.");
	request.getRequestDispatcher("residential_bill.jsp").forward(request, response);
}
%>