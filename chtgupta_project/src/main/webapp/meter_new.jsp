...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Add New Meter</font>
	</div>
	<div class="card ">
	  ...
	  <div class="card-body">
		...
		%>
	    <p class="card-text">Enter New Meter Details</p>
	    <label class="mt-2">Circle Name</label>
	    <input class="form-control" type="text" name="cname" value="<%out.println(cname);%>" readonly>
	    <label class="mt-3">Division Name</label>
	    <input class="form-control" type="text" name="dname" value="<%out.println(dname);%>" readonly>
	    <label class="mt-3">Meter No</label>
	    <input class="form-control" type="text" name="mno" required>
	    <label class="mt-3">Company Name</label>
	    <input class="form-control" type="text" name="mcname" required>
		<input class="mt-3 btn btn-primary" type="submit">
		</form>
	  </div>
	</div>
</div>
