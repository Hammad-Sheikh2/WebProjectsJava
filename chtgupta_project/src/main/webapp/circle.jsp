...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Circle Details </font>
	</div>
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
	    <p class="card-text">Click this button to register a new circle in the system</p>
	    <div class="d-flex justify-content-end">
	    	<button class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModal">Add New Circle</button>
	    </div>
	  </div>
	</div>
	<%! 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Circle</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      	<p>Enter New Circle Details</p>
        <form action="circle_registration.jsp">
        	<input name="idno" type="number" class="form-control mt-3" placeholder="No" required>
        	<input name="name" type="text" class="form-control mt-3" placeholder="Name" required>
