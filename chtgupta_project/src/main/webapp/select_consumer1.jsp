...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">View Consumer Details</font>
	</div>
	<div class="card ">
	  ...
	  <div class="card-body">
		...
		%>
	    <p class="card-text">Select Consumer ID for view its details from system.</p>
	    <select class="form-control mt-2" name="no" required>
	    <%
		...
		<div class="d-flex justify-content-end">
			<input class="btn btn-warning mt-3" type="submit" value="View Details">
		</div>
		</form>
	  </div>
	</div>
