...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Division Selection</font>
	</div>
	<div class="card ">
	  <div class="card-header">
	    <b>Division Details</b>
	  </div>
	  <div class="card-body">
		...
		%>
	    <p class="card-text">Select Division Name</p>
	    <input type="hidden" name="cname" value="<%out.println(cname);%>" readonly>
	    <select class="form-control mt-2" name="dname" required>
	    <%
