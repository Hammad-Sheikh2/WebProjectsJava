...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Division Details</font>
	</div>
	...
	<div class="card mt-3">
	  <div class="card-header">
	    <b>Add New Division</b>
	  </div>
	  <div class="card-body">
	    <p class="card-text">Click this button to register a new division in the system.</p>
	    <div class="d-flex justify-content-end">
	    	<button class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModal">Add New Division</button>
	    </div>
	  </div>
	</div>
	<%! 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<p>Enter New Division Details</p>
        <form action="division_registration.jsp">
        	<input name="idno" type="number" class="form-control mt-3" placeholder="No" required>
        	<select name="cname" class="form-control mt-3" required>
        		<%
					while(rs.next())
				{%>
        	...
        	<input name="dname" type="text" class="form-control mt-3" placeholder="Name" required>
