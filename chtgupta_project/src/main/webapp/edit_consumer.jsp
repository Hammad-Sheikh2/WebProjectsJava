...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Update Consumer Details</font>
	</div>
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
	    	...
	    	<input class="form-control" type="text" name="name" value="<%out.println(rs.getString(5));%>" required>
	    	
	    	<label class="mt-3">Age</label>
	    	<input class="form-control" type="text" name="age" value="<%out.println(rs.getString(6));%>" required>
	    	...
	    	<input class="form-control" type="text" name="cno" value="<%out.println(rs.getString(8));%>" required>
	    	
	    	<label class="mt-3">Address</label>
	    	<textarea class="form-control" type="text" name="address" rows="4" required><%out.println(rs.getString(9));%></textarea>
	    	...
	    	<input class="form-control" type="text" name="uname" value="<%out.println(rs.getString(11));%>" required>
	    	
	    	<label class="mt-3">Password</label>
	    	<input class="form-control" type="password" name="pass" value="<%out.println(rs.getString(12));%>" required>
