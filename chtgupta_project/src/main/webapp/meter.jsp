...
<div class="container my-5">
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
	    <p class="card-text">Click this button to register a new meter in the system</p>
	    <div class="d-flex justify-content-end">
	    	<button class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModal">Add New Meter</button>
	    </div>
	  </div>
	</div>
	<%! 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Meter</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      	<p>Select Circle Name</p>
        <form action="division_name_selection.jsp">
