...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Meter Details</font>
	</div>
	<div class="card ">
	  ...
	  <div class="card-body">
	  	<p class="card-text">Enter number of units used by this meter.</p>
	    ...
	    <%
	    	...
	    	<input class="form-control" type="text" name="name" value="<%out.println(rs.getString(5));%>" readonly>
	    	
	    	<label class="mt-3">Connection Type</label>
	    	<input class="form-control" type="text" name="type" value="<%out.println(rs.getString(10));%>" readonly>
	    	
	    	<label class="mt-3">No Of Units Used</label>
	    	<input class="form-control" type="number" name="used" required>
