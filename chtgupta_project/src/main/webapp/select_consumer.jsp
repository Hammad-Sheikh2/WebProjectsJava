...
<div class="container my-5">
	<div class="display-4 text-warning d-flex justify-content-center" >
		<font face="Monotype Corsiva">Edit Consumer Details</font>
	</div>
	<div class="card ">
	  ...
	  <div class="card-body">
		...
		%>
	    <p class="card-text">Select Consumer ID for edit its details from system.</p>
		...
		<div class="d-flex justify-content-end">
			<input class="btn btn-dark mt-3" type="submit" value="View Details">
		</div>
		</form>
	  </div>
	</div>
