	...
	<div class="card ">
	  ...
	  <div class="card-body">
	    ...
	    <%
	    	...
	    	<input class="form-control" type="text" name="mcname" value="<%out.println(rs.getString(5));%>" readonly>
	    	...
	    	<input class="mb-5 form-control" type="text" name="type" value="<%out.println(rs.getString(12));%>" readonly>
			<%}}
				catch(Exception e)
			{
					out.println(e);
