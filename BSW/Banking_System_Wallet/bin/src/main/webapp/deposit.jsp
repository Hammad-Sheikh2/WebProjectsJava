...
<div class="container mt-3">
    <div class="card mt-3">
        ...
        <div class="card-body">
            <h5 class="card-title text-warning">Deposit Service</h5>
            <p class="card-text">Here you can <strong>Deposit</strong> your selected account balance amount to other account.</p>
        </div>
    ...
    <div class="my-3">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="card-title mt-2">Select account and amount to deposit</h5>
                ...
                <div class="input-group mt-3">
                    ...
                    <input type="number" name="amount" class="form-control" id="amount" placeholder="Amount To Deposit" aria-describedby="forAmount" required>
                </div>
                <div id="errorMsg"></div>
                <button onclick="Amount_Deposit_Request()" class="mt-3 btn btn-info">Deposit</button>
            </div>
        </div>
    </div>
    <%
...
<script>
    function Amount_Deposit_Request(){
