...
<div class="container mt-3">
    <div class="card">
        <h3 class="card-header">Create Course</h3>
        <div class="card-body">
            <form action="./CreateCourse" method="post" class="mt-5">
                <div class="input-group mt-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="forName"><i class="fas fa-signature"></i></span>
                    </div>
                    <input type="text" name="courseName" class="form-control" placeholder="Course Name" aria-describedby="forName" required>
                </div>
