...
<head>
    ...
    <title>Fußball-Weltmeisterschaft 2021</title>
    <style>
        body{
            display: flex;
            flex-wrap: wrap;
...
<body>
    <div class="container">
        ...
        <!--From Line 122 to 133 It display the UI Block where you see Match Fixtures and Standings but in this
        UI Design will be randomly change according to data-->
        <div style="display: none;border: none" id="GamesPlanPortion" class="card">
            <h5 class="card-header text-white" style="background: #380038;">Fußball-Weltmeisterschaft 2021</h5>
            <div class="card-body">
                <div class="row">
...
<script>
    ...
    function SubmitNamesAndGoToGamePlan(){
        //This Code Send Request and Team Names as Data to Servlet to Save Names and get response all Data
        //All Data means list of Teams , list of Matches etc.
        //All the code in this page where $.ajax use send data according to function name and recieve all data.
        $.ajax({
            type:"POST",
            url: "./requestHandler",
            data:{
