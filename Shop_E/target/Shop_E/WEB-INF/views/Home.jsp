    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active px-3" style="cursor: pointer">
                <a style="border-bottom: none" class="nav-link"><i class="fas fa-home"></i> Home<span class="sr-only">(current)</span></a>
            </li>
...
<script>
    function GetAllData(){
        $.ajax({
            url:"http://localhost:8080/Shop_E_war/App/",
            method:"POST",
            success:(data)=>{
                ...
                if(data.status){
                    ...
                    if(counter==0){
                        div.innerHTML="<div class=\"jumbotron\"><h1 class=\"display-4\"><i class=\"fas fa-frown\"></i>No Data Found!</h1><p class=\"lead\">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p><hr class=\"my-4\"><p>It uses utility classes for typography and spacing to space content out within the larger container.</p><p class=\"lead\"><button class=\"btn btn-primary btn-lg\">Learn more</button></p></div>";
                    }
                    ...
                    let div=document.createElement("DIV")
                    div.innerHTML="<div class=\"jumbotron\"><h1 class=\"display-4\"><i class=\"fas fa-frown\"></i> "+data.message+"!</h1><p class=\"lead\">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p><hr class=\"my-4\"><p>It uses utility classes for typography and spacing to space content out within the larger container.</p><p class=\"lead\"><button class=\"btn btn-primary btn-lg\">Learn more</button></p></div>";
                    document.getElementById("Page-Data").innerHTML=""
                    document.getElementById("Page-Data").appendChild(div)
                }
            },
    ...
    function SearchData(){
        $.ajax({
            url:"http://localhost:8080/Shop_E_war/App/Search-Items",
            method:"POST",
            data:{
