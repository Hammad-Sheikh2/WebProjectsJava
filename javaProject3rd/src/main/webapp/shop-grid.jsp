...
<body>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <%for(Department d : (ArrayList<Department>)request.getAttribute("departments")){%>
                            <li><a href="./shop?category=<%=d.id%>"><%=d.name%></a></li>
                            <%}%>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="./shop">
                                ...
                                <button type="submit" class="site-btn">FIND</button>
                            </form>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2><%=request.getAttribute("cat")%></h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span><%=((ArrayList<Product>)(request.getAttribute("products"))).size()%></span> Product(s) found</h6>
                                </div>
                            </div>
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/<%=p.image%>">
                                    <ul class="product__item__pic__hover">
                                        ...
                                        <li><a href="#" onclick="add_to_cart(<%=p.id%>)"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="./product?id=<%=p.id%>"><%=p.name%></a></h6>
                                    <h5>$<%=p.buyPrice%></h5>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="footer spad">
        <div class="container">
            ...
            <div class="row">
                <div class="footer__copyright__payment"><img src="img/payment-item.png" alt=""></div>            </div>
        </div>
    </footer>
    <!-- Footer Section End -->
...
<script>
    function add_to_cart(pid){
        fetch("cart?pid="+pid, {method:"POST"})
        .then(res => res.json())
