                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <tbody>
                            <%for(Cart cart : (ArrayList<Cart>)request.getAttribute("carts")){%>
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/product/<%=cart.image%>" alt="">
                                        <h5><%=cart.name%></h5>
                                    </td>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty" onclick="update_all()">
                                    ...
                                    <td class="shoping__cart__item__close" onclick="$(this).parent().remove(); update_all()">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Cart Total</h5>
                        <ul>
                            <li>Subtotal <span class="sum">$<%=total%></span></li>
                            <li>Total <span class="sum">$<%=total%></span></li>
                        </ul>
    ...
    <script>
        function update_all() {
            ...
            $("table tbody tr").each(function(){
                let sub = parseFloat($(this).find(".shoping__cart__price").text().trim().substring(1));
                let count = parseInt($(this).find("input").val());
                let price = sub*count;
                $(this).find(".shoping__cart__total").text("$"+price);
                total += price;
            });
            $(".sum").text("$"+total);
        }
        function checkout(){
            ...
            let sum = $(".sum").eq(0).text().trim().substring(1);
            fetch("checkout?price="+sum, {method:"POST"})
                .then(res=>res.json())
